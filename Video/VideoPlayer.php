<?php
    ...
    $sql = "SELECT course.CourseName, course.CourseName, chapter.ChapterName, sesi.sessionName, video.videoLink FROM course
    ...
    $sql1 = "SELECT course.CourseName, course.CourseName, chapter.ChapterName FROM course
    JOIN chapter ON (course.CourseID = chapter.CourseID)
    JOIN sesi ON (chapter.ChapterID = sesi.ChapterID)
    WHERE course.CourseID =  $chapter";
...
<head>
    <meta charset="utf-8">
    <title>Ruang Siswa - Ruang Siswa HTML Template</title>
    ...
    <div class="container">
        <?php
         ...
         ?>
            ...
            <?php
            $videos = mysqli_fetch_assoc($Video)
            ?>

            <div style="text-align:center;width:100%;" >
                <iframe width="100%" height="600"
                    src="<?php echo $videos["videoLink"];?>"
