        ...
        <div class="container-xxl py-5 category">
            <div class="container">
                <div class="text-center wow fadeInUp" data-wow-delay="0.1s">
                    ...
                    <h1 class="mb-5">List Tutor Course</h1>
                </div>
                <div class="container">
                    ...
                    while($teach = mysqli_fetch_assoc($tch)){
                        ?>
                        <div class="py-1">
                            <a href="TTRDetCourse.php?crs=<?php echo $teach['CourseID'];?>&tID=<?php echo $teach['TutorID'];?>&cls=<?php echo $teach['Grade'];?>" class="btn btn-white btn-lg-crcl px-4 py-1 nav-linked upscale-20 section-title-custom"><?php echo  $teach['CourseName']; echo ": ";   echo "Grade "; echo $teach['Grade'];?></a>
                        </div>
                        <?php
                    }
                    ?>
