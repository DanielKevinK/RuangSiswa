            ...
            <div class="container">
                ...
                <div class="container">
                    ...
                    while($teach = mysqli_fetch_assoc($tch)){
                        ?>
                        <div class="py-1">
                            <a href="listEnrolled.php?crs=<?php echo $teach['CourseID'];?>&tID=<?php echo $teach['TutorID'];?>&cls=<?php echo $teach['Grade'];?>" class="btn btn-white btn-lg-crcl px-4 py-1 nav-linked upscale-20 section-title-custom"><?php echo  $teach['CourseName']; echo ": ";   echo "Grade "; echo $teach['Grade'];?></a>
                        </div>
                        <?php
                    }
                    ?>
