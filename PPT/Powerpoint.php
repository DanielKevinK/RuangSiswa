<?php
    ...
    $sql = "SELECT course.CourseName, course.CourseName, chapter.ChapterName, sesi.sessionName, ppt.pptLink FROM course
...
<body>
    ...
    <div class="container">
        ...
        <?php
        $powerpoint = mysqli_fetch_assoc($ppt)
        ?>

            <div style="text-align:center;width:100%;" >
                <iframe width="100%" height="600"
                    src="<?php echo $powerpoint["pptLink"];?>"
