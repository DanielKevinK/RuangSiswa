<?php
    ...
    $sql = "SELECT * FROM chapterquiz";
    $course = $conn->query($sql);
    $quizz = $conn->query($sql);
...
<body>
    ...
    <div class="container-xxl py-5 category">
        <div class="container">
            ...
            <?php while($quiz = mysqli_fetch_assoc($quizz)){ ?>
            <div class="container py-1">
            <a href="leaderboard.php?v=<?php echo $quiz['QuizID']?>" class="btn btn-white btn-lg-course py-3 px-4 mt-2"><?php echo $quiz["quizName"];?></a>
            </div>
            <?php
                }
            ?>
